...
echo -e "${RED}==> Внимание! ${BOLD}Если Вы не знакомы с НОВЫМ Pacman gui (pamac-all), или (pamac-all-git), то СОВЕТУЮ зайдите на сайт загрузки (указаны выше), изучите 'Конфликты и Зависимости'. То есть команды прописаны через (yay -S ##### --noconfirm). ${NC}"
