...
#echo "Проверим корректность загрузки установленных микрокодов"
# Find out the version and release data for Arch ... :)
...
echo " Будьте внимательны! Если Вы сомневаетесь в своих действиях, можно пропустить это действие. "
echo ""
while
