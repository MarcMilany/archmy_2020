...
clear
echo -e "${MAGENTA}
  <<< Смена зеркал для увеличения скорости загрузки утилит (пакетов) >>> ${NC}"
echo -e "${YELLOW}==> Примечание: ${NC}Смена зеркал предоставлена только для зеркала 'Russia', или пропустить установку." 
