...
echo -e "${MAGENTA}:: ${BOLD}Breeze Default Cursor Theme (breeze-default-cursor-theme) - это тема x-cursor, вдохновленная macOS и основанная на KDE Breeze. Исходные файлы были созданы в Inkscape, а тема была разработана так, чтобы хорошо сочетаться с набором значков La Capitaine. ${NC}"
echo " Этот курсор должен масштабироваться соответствующим образом для любого разрешения экрана. " 
echo " Если Вы сочтёте его слишком маленьким на ваш вкус, поищите параметры масштабирования курсора в настройках рабочего стола :). (https://github.com/keeferrourke/capitaine-cursors) "
echo "" 
while  
