...
sudo pacman -S --noconfirm --needed arc-gtk-theme  # Плоская тема с прозрачными элементами для GTK 3, GTK 2 и Gnome-Shell
echo ""   
echo " Установка утилит (пакетов) выполнена "
fi
...
#### arc-firefox-theme ####
git clone https://github.com/horst3180/arc-firefox-theme  # Тема Arc Firefox
