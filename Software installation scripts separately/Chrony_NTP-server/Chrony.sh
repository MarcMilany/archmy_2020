...
if [[ $x_chrony == 0 ]]; then
 ...
 echo " Установка утилит (пакетов) пропущена " 
  ...
  echo ""
sudo pacman -S --noconfirm --needed chrony  # Легкий клиент и сервер NTP ; https://chrony-project.org/ ; https://archlinux.org/packages/extra/x86_64/chrony/ ; 2024-11-05 19:29 UTC
  echo ""
