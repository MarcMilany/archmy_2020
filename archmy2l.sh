...
echo -e "${CYAN}:: ${NC}Важно! Если Вы НЕ установили Xfce4 (окружения рабочего стола) - рекомендую вариант "0" (для вас действие будет пропущено, и сможете вернутся к этому вопросу с нужным DE) "
