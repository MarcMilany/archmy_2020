...
#sed -i 's/#Cache=yes/Cache=yes\n/g' /etc/systemd/resolved.conf
sed -i '/^#MulticastDNS=yes/ MulticastDNS=no' /etc/systemd/resolved.conf  
sed -i '/^#LLMNR=yes/ LLMNR=no' /etc/systemd/resolved.conf
#####################
