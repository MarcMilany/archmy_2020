...
touch ~/home $username:users .alias_zsh
# touch ~/.alias_zsh   # Создать файл в ~/.alias_zsh
cat > ~/home $username:users .alias_zsh <<EOF
#!/usr/bin/zsh
...
chmod a+x ~/home $username:users .zshrc
echo " Для начала сделаем его бэкап  ~/.zshrc "
# cp ~/.zshrc  ~/.zshrc.back
cp ~/home $username:users .zshrc  ~/home $username:users .zshrc.back 
...
touch ~/home $username:users .Xresources
# touch ~/.Xresources   # Создать файл в ~/.Xresources
cat > ~/home $username:users .Xresources <<EOF
Xft.dpi: 96
Xft.antialias: true
Xft.hinting: true
Xft.rgba: rgb
...
chmod a+x ~/home $username:users .Xresources
############
