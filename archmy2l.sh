...
# pacman -Sy networkmanager networkmanager-openvpn network-manager-applet ppp --noconfirm
  pacman -S --noconfirm --needed dhcpcd  # Клиент DHCP/ IPv4LL/ IPv6RA/ DHCPv6 ; https://roy.marples.name/projects/dhcpcd/ ; https://archlinux.org/packages/extra/x86_64/dhcpcd/ 
  echo ""
