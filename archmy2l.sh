...
echo -e "${CYAN}:: ${NC}Для создания символической ссылки используйте команду "ln -sf" или "ln -svf" (где Region - ваш регион, City - ваш город)"
...
echo -e "${GREEN}:: ${NC}Примеры (timezone): Europe/Moscow, Europe/Minsk, Europe/Kiev, Europe/Berlin, Europe/Paris, Asia/Yekaterinburg, Asia/Almaty, Africa/Nairobi, America/Chicago,  и т.д...."
...
echo -e "${YELLOW}==> ${NC}Вы можете пропустить этот шаг, если сейчас ваш часой пояс настрон правильно, или не уверены в правильности выбора"
