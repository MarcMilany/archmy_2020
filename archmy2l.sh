...
lsblk -f
echo ""
echo -e "${YELLOW}=> ${BOLD}Примечание: /dev/sdX - диск (не раздел), на котором должен быть установлен GRUB. ${NC}"
echo ""
...
echo " Пример: (root P 10/11/2020 -1 -1 -1 -1; или $username P 10/11/2020 0 99999 7 -1) "
