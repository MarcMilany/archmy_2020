# 🐧 ArchLinux Fast Install v2.5 LegasyBIOS Update

★★☆☆☆

# Предисловие 👌
🗨️ У написанного здесь нет цели учить, настаивать, либо диктовать.
...
Моменты доработки вовсе 'Не говорят' нам, что скриптами нельзя пользоваться. 👋
...
*Примечание: Зарание извините! Если у кого не отработает какой либо скрипт ⚙️ 
...
- 3-й - мой скрипт (конфиг) системы. Установка нужных программ и т.д.
...
✨ НЕ Забывайте скрипт уже прописан под LegasyBIOS и UEFI! 
...
👇 Для проверки образа в Windows потребуется:

Небольшая утилита для рассчета MD5SHA хэш строк, файлов или групп файлов. Поддерживает следующие хэши MD5, SHA1, SHA256, SHA384 и SHA512. Может сканировать все файлы из папки с подпапками и создавать отчет с файлом контрольной суммы всех файлов с именем и размером файла.
- MD5 Checksum Tool - https://www.appsvoid.com/products/md5-checksum-tool/
  
*Примечание: Системные требования - Windows xp и выше
...
🏁 3-я часть не обязательная. Она устанавливает программы, AUR (yay), мои конфиги XFCE.
...
### 28.09.2025 ArchLinux Fast Install v2.5 LegasyBIOS
...
но пользоваться можно сам сегодня (27.09.2025г.) устанавливал. 
