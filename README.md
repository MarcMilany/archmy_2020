...
(Специально для начинающих Гуру Arch'a в master ветке, в папке 'working draft of the script' оставил рабочий (черновой) проект сценария, с "Чё почём (разговорное наречие)" - пояснениями, ссылками на материал и т.д.) 
Ознакомиться можно (нужно) !
