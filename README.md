...
### Видео с демонстрацией работы скрипта https://www.youtube.com/watch?v=nvVF_qKDUeM (Устарело!)
...
2) Команды для скачивания и запуска скрипта изменились, в связи с тем, что в установочный образ Arch Linux 2024.08.01-x86_64.iso ., не входит пакет 'wget', в отличае от предыдущего релиза Arch Linux .iso . (см.,PKGLIST_X86_64.txt - находится в установочном .iso образе)
...
Скачать и запустить скрипт можно командой:
   ...
   ```
# Примечание (обратить внимание)! 
Если Вы скачали Arch Linux 2020.09.01-x86_64.iso ., то команда для запуска
...
### 24.08.2024 ArchLinux Fast Install v2.4 LegasyBIOS
