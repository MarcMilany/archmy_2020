...
echo " Действия ввода, выполняется сразу после нажатия клавиши "
    ...
    0 - НЕТ - Пропустить установку: " i_transmission  # sends right after the keypress; # отправляет сразу после нажатия клавиши
    echo ''
    [[ "$i_transmission" =~ [^120] ]]
do
    :
...
echo ""   
echo " Установка утилит (пакетов) выполнена "
elif [[ $i_transmission == 2 ]]; then
  echo ""  
  echo " Установка BitTorrent-клиента Transmission (Qt) "
sudo pacman -Syy  # обновление баз пакмэна (pacman)
