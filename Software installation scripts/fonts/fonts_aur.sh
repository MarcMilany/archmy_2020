...
apptitle="Arch Linux Fast Install v2.4 LegasyBIOS - Version: 2020.07.31.00.40.38 (GPLv3)"
...
FONTS_AUR="russian"  # Installer default language (Язык установки по умолчанию)
