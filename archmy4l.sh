...
sudo pacman -S ttf-ubuntu-font-family --noconfirm  # Семейство шрифтов Ubuntu - красивые, не вырвиглазные шрифты без засечек, использую в DE и текстовых документах. (Помечено как устаревшее 03.08.2023)
...
sudo pacman -S ttf-roboto --noconfirm  # Фирменное семейство шрифтов Google (возможно уже установлен)(Помечен как устаревший 24 июня 2023 г.)
...
sudo pacman -S ttf-hanazono --noconfirm  # Бесплатный японский шрифт кандзи, который содержит около 78 685 символов (и 2 пробела), определенный в стандарте ISO / IEC 10646 / стандарте Unicode.(Помечено как устаревшее 18.05.2024)
...
yay -S font-manager-git --noconfirm  # Простое приложение для управления шрифтами для GTK + Desktop Environments  
...
yay -S ttf-ionicons --noconfirm  # Шрифт из мобильного фреймворка Ionic
...
yay -S ttf-nerd-fonts-hack-complete-git --noconfirm  # Шрифт, разработанный для исходного кода. Исправлены иконки Nerd Fonts (Помечено как устаревшее (2023-11-13))
...
yay -S font-bh-ttf --noconfirm  # Шрифты X.org Luxi Truetype 
# yay -S  --noconfirm  #
# yay -S  --noconfirm  #
# yay -S  --noconfirm  #
pwd  # покажет в какой директории мы находимся
...
sudo pacman -S mediainfo --noconfirm  # Предоставляет техническую и теговую информацию о видео или аудио файле (интерфейс командной строки)(Помечен как устаревший 27 июня 2024 г.)
sudo pacman -S mediainfo-gui --noconfirm  # Предоставляет техническую и теговую информацию о видео или аудио файле (интерфейс GUI)(Помечен как устаревший 27 июня 2024 г.)
