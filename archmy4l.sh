...
clear
echo -e "${MAGENTA}
  <<< Установка дополнительных утилит для восстановления данных с поврежденного жесткого диска (Если Вы обнаружите, что возникли ошибоки чтения диска, и начали сыпаться ошибками на консоль и в лог). >>> ${NC}"
echo ""
