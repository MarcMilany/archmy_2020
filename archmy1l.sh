...
sub='defaults,rw,noatime,compress=zstd:2,ssd,space_cache=v2,discard=async,commit=120'
case "$sub " in
esac
...
#sub='rw,noatime,compress=zstd:2,ssd,space_cache=v2,discard=async,subvol'  # для SSD (Solid-State Drive) - Nvme - m2 - usb_flash
# sub='defaults,rw,noatime,compress=zstd:2,ssd,space_cache=v2,discard=async,commit=120'  # для SSD (Solid-State Drive) - Nvme - m2 - usb_flash
#sub='rw,noatime,compress=zstd:2,ssd,space_cache=v2,discard=async,subvol'  # для SSD (Solid-State Drive) - Nvme - m2 - usb_flash
