...
#read -p " 1 - Да форматировать, 0 - Нет пропустить: " boots  # To confirm the input actions, click 'Enter' ; # Чтобы подтвердить действия ввода, нажмите кнопку 'Ввод' ("Enter") 
    read -p " 
    1 - Да форматировать,    0 - Нет пропустить: " boots  # To confirm the input actions, click 'Enter' ; # Чтобы подтвердить действия ввода, нажмите кнопку 'Ввод' ("Enter") 
    echo ''
    [[ "$boots" =~ [^12] ]]
do
    :
...
#read -p " 1 - Да добавить Home раздел, 0 - Нет не добавлять: " homes  # To confirm the input actions, click 'Enter' ; # Чтобы подтвердить действия ввода, нажмите кнопку 'Ввод' ("Enter") 
    read -p " 
    1 - Да добавить Home раздел,    0 - Нет не добавлять: " homes  # To confirm the input actions, click 'Enter' ; # Чтобы подтвердить действия ввода, нажмите кнопку 'Ввод' ("Enter") 
    echo ''
    [[ "$homes" =~ [^10] ]]
do
    :
...
# --------------------------------
    for (( SECOND=10; SECOND>=1; SECOND-- )); do
        echo -ne "\r\033[K${GREEN}${MSG_REBOOT} ${SECOND}Размонтирование всех смонтированных файловых систем (кроме корневой).${NC}"
        sleep 01
    done
    umount -a
    reboot
