...
Но в последствие! Эта концепция была пересмотрена, и в скрипт был добавлен выбор DE, разметка диска и другими плюшками. И он (скрипт) НЕ предназначен для новичков! 
