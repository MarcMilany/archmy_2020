Было бы неплохо иметь оболочку для установки флагов, как во всех браузерах на Arch.

https://aur.archlinux.org/packages/freetube-bin

Для этого потребуется включить этот скрипт в установку и изменить файл .desktop.
