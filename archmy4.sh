...
dpkg 1.20.5-2
Действия пакета
Исходные файлы / просмотр изменений
Отчеты об ошибках / Добавить новую ошибку
Искать в вики
Проблемы с безопасностью
Пометить пакет как устаревший (?)
Скачать с зеркала
Архитектура:  x86_64
Репозиторий:  Сообщество
Описание: Инструменты диспетчера пакетов Debian
URL восходящего направления:  https://tracker.debian.org/pkg/dpkg
Лицензия (и): GPL
Сопровождающие: Анатолий Помозов
Размер посылки: 1,8 МБ
Установленный размер: 8,3 МБ
Последний упаковщик:  Анатолий Помозов
Дата постройки: 2020-10-13 16:25 UTC
Подписано:  Анатолий Помозов
Дата подписания:  2020-10-13 16:28 UTC
Последнее обновление: 2020-10-13 16:31 UTC
...
Подробности пакета: dpkg-git 1.19.4.r5.g42bf88145-1
Действия пакета
Просмотр PKGBUILD / Просмотр изменений
Скачать снимок
Искать в вики
Отметить пакет устаревшим
Проголосуйте за этот пакет
Включить уведомления
Отправить запрос
Git Clone URL:  https://aur.archlinux.org/dpkg-git.git (только для чтения, нажмите, чтобы скопировать)
База пакета:  dpkg-git
...
Первый отправленный:  2019-01-30 18:50
Последнее обновление: 2019-01-30 18:50
...
# dpkg -i package.deb
ответил superuser0 18 июля 2013, 23:30:37
7
...
Установите dpkg с помощью yaourt:
